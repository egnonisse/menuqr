...
const navigation = [
  ...
  { name: "Page d'accueil", href: "/admin/homepage", icon: GlobeAltIcon, current: false },
  { name: "Profil", href: "/admin/profile", icon: UserIcon, current: false },
  { name: "Paramètres", href: "/admin/settings", icon: CogIcon, current: false },
  { name: "Horaires", href: "/admin/hours", icon: ClockIcon, current: false },
];
    ...
    <div>
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                  <div className="flex h-16 shrink-0 items-center">
                    <h1 className="text-xl font-bold text-indigo-600">MenuQR Admin</h1>
                  </div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-indigo-600 px-6">
          <div className="flex h-16 shrink-0 items-center">
            <h1 className="text-xl font-bold text-white">MenuQR Admin</h1>
          </div>
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              <li>
